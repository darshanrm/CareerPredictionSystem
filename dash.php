...
<!-- dropdown input for department-->
<div class="form-group">
 <div class="col-md-12">
 <select name="department" class="browser-default custom-select form-control">
  <option selected>Open this select menu</option>
  <option value="chemical engineering">Chemical engineering</option>
  <option value="civil engineering">Civil Engineering</option>
  <option value="computer engineering">Computer Engineering</option>
  <option value="mechanical engineering">Mechanical Engineering</option>
  <option value="electronics & electrical engineering">Electronics Engineering</option>
  <option value="electronics & electrical engineering">Electrical Engineering</option>
</select>
 </div>
</div>
